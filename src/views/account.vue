          ...
          <div class="avatar gray-box clear">
            ...
            <div class="box-inner">
              <ul class="account-nav">
                <router-link exact tag="li" :to="{ name: 'account'}" active-class="current">
                  <a>我的订单</a>
                </router-link>
<!--                <router-link @click="cleanToken" tag="li" :to="{name:'login'}"  active-class="current">-->
<!--                  <a>登出</a>-->
<!--                </router-link>-->
                <router-link  tag="li" :to="{ name: 'ads'}" active-class="current">
                  <a>收货地址</a>
                </router-link>
