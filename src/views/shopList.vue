<template>
  <div id="shopList" class="hander-car">
    <div class="store-content">
      <div class="cart-box">
        ...
        <div class="cart-inner">
          <div class="empty-label " v-if="!calTotalCount">
            <h3>您的购物车中还没有商品</h3>
                  ...
                  <div class="cart-items">
                    ...
                    <div class="name hide-row" >
                      <div class="name-table">
                        <router-link :to="{name:'item',query:{itemId:item.id}}">{{item.name}}</router-link>
                        <ul class="attribute">
                          <li>{{item.name}}</li>
                        </ul>
                      </div>
                    ...
                    <div class="operation">
                      <a class="items-delete-btn" @click="delCarPanelData(item)" ></a>
                    </div>
                    ...
                    <div class="item-cols-num">
                      <div class="select js-select-quantity">
                        ...
                        <span class="up":class="{'up-disabled':item.count >= item.store}"  @click="plusCount(item)">+</span>
        ...
        <div class="cart-bottom-bg fix-bottom" v-if="calTotalCount">
            ...
            <div>
              <div class="choose-all js-choose-all">
                <span
                  ...
                  @click = "toogleAllcheck"
                >
                  <a></a>
                </span>
                全选
              </div>
<!--              <div class="delete-choose-goods" @click="delAllcheckGoods" >删除选中的商品</div>-->
            </div>
          </div>
          <div class="shipping">
...
export default {
  ...
  methods: {
    ...
    plusCount(item){//增加商品数目
      ...
      this.$axios.put('/cart/updateGoodsNumber',{
        goodsId:item.id,
        number:item.count
      }).then(res=>{
